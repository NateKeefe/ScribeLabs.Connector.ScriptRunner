...
namespace ScribeLabs.Connector.ScriptRunner
{
    class ScriptRunnerService
    {
        ...
        public OperationResult ExecuteExecute(OperationInput input)
        {
            ...
            // execute the script
            var executionResult = executeCommand(interpreter, script, scriptArguments, true);

            // package the results
            var outputDE = ExecutionResultToDataEntity(ObjectNames.Script, interpreter, script, scriptArguments, executionResult);
            var success = true;
        ...
        private ExecutionResult executeCommand(string interpreter, string script, string scriptArguments, bool isScriptCommand, int msTimeout = -1)
        {
        ...
        private DataEntity ExecutionResultToDataEntity(string objDefName, string interpreter, string script, string scriptArguments, ExecutionResult executionResult)
        {
